...
public interface ProjectRepository extends JpaRepository<ProjectEntity,Long> {
    ...
    @Query(value = "select p.* from project p join timesheet t on p.project_id = t.project_id join users u on t.users_id = u.users_id where u.users_id = :userId group by project_id",
            nativeQuery = true)
